...
## <a name="renewable-subscriptions"></a>可续订的订阅

如果在 2018 年 8 月之前注册了订阅，可能会有可续订的订阅。 如果订阅处于非活动状态，你将在仪表板上看到以下警告。 
...
## <a name="how-do-i-migrate-my-data-when-my-subscription-expires"></a>订阅到期后，如何迁移我的数据？
